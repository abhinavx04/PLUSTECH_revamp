    ...
    <>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: '#00aeef' }}>
            About Us
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                <h4 className="font-semibold text-white mb-2">Design & Engineering</h4>
                <p className="text-sm text-gray-400">Custom solutions for your specific needs</p>
              </div>
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                <h4 className="font-semibold text-white mb-2">Automated Systems</h4>
                <p className="text-sm text-gray-400">Semi & fully automatic plants</p>
              </div>
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                <h4 className="font-semibold text-white mb-2">End-to-End Service</h4>
                <p className="text-sm text-gray-400">From design to commissioning</p>
              </div>
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                <h4 className="font-semibold text-white mb-2">Industry Expertise</h4>
                <p className="text-sm text-gray-400">Automotive & general applications</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-blue-500/10 to-teal-500/10 rounded-2xl p-8 border border-gray-700/30">
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Optimized processes</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Reliable deliverables</p>
                  </div>
                </div>
              </div>
            </div>
