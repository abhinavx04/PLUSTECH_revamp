...
const CertificationManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold text-white">Certifications ({certifications.length})</h3>
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-gray-400 mt-1 flex items-center gap-3 flex-wrap">
                    <span>Issuing: {item.issuingBody}</span>
                    <span>
                      Valid until:{' '}
                      {item.validUntil
                    ...
                    {item.sortOrder !== undefined && <span>Order: {item.sortOrder}</span>}
                  </div>
                </div>
